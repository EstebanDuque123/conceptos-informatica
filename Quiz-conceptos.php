...
<meta name="dc:title" content="Quiz" />
...
I[0][2]='0';
I[0][3]=new Array();
I[0][3][0]=new Array('Es el conjunto de componentes f\u00EDsicos del computador.','',0,0,1);
I[0][3][1]=new Array('Es el soporte l\u00F3gico que permite que la computadora pueda desempe\u00F1ar tareas, dirigiendo componentes f\u00EDsicos con instrucciones.','',1,100,1);
I[0][3][2]=new Array('Es la unidad de proceso central, que se encarga e controlar todo lo que ocurre en el ordenador.','',0,0,1);
I[0][3][3]=new Array('Es el tratamiento autom\u00E1tico de la informaci\u00F3n.','',0,0,1);
...
<li class="QuizQuestion" id="Q_0" style="display: none;"><div class="QuestionText">&#x00BF;Qu&#x00E9; es el software?</div><ol class="MCAnswers"><li id="Q_0_0"><button class="FuncButton" id="Q_0_0_Btn" onclick="CheckMCAnswer(0,0,this)">?</button>&#160;&#160;Es el conjunto de componentes f&#x00ED;sicos del computador.</li><li id="Q_0_1"><button class="FuncButton" id="Q_0_1_Btn" onclick="CheckMCAnswer(0,1,this)">?</button>&#160;&#160;Es el soporte l&#x00F3;gico que permite que la computadora pueda desempe&#x00F1;ar tareas, dirigiendo componentes f&#x00ED;sicos con instrucciones.</li><li id="Q_0_2"><button class="FuncButton" id="Q_0_2_Btn" onclick="CheckMCAnswer(0,2,this)">?</button>&#160;&#160;Es la unidad de proceso central, que se encarga e controlar todo lo que ocurre en el ordenador.</li><li id="Q_0_3"><button class="FuncButton" id="Q_0_3_Btn" onclick="CheckMCAnswer(0,3,this)">?</button>&#160;&#160;Es el tratamiento autom&#x00E1;tico de la informaci&#x00F3;n.</li></ol></li></ol>
