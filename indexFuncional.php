...
if(!isset($_SESSION['access_token']))
{
 ...
 $login_button = '<a href="'.$google_client->createAuthUrl().'">Iniciar sesión con Google</a>';
}
...
<html>
 <head>
  ...
  <title>Conceptos Basicos de Informatica</title>
  <meta charset="utf-8">
...
table,td {
 ...
 <body>
  <div class="container">
   <br />
   <h2 align="center">Conceptos Basicos de Informatica</h2>
   <br />
