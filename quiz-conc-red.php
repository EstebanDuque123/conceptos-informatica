...
<meta name="dc:title" content="Quiz-conc. redes" />
<script src="http://ajax.googleapis.com/ajax/libs/jquery/2.1.1/jquery.min.js" type="text/javascript"></script>

<script>
	function enviar()
	{
		    var v1= "Quiz conceptos de red";
...
I[0][2]='0';
I[0][3]=new Array();
I[0][3][0]=new Array('Tejido de mallas, cuerdas, alambres, etc, realizado para diversos usos. ej: (red de pesca).','',0,0,1);
I[0][3][1]=new Array('Conjunto de ordenadores que se conectan entre s\u00ED e intercambian informaci\u00F3n constantemente.','',1,100,1);
I[0][3][2]=new Array('Es aquella conformada por generadores el\u00E9ctricos, transformadores l\u00EDneas de transmisi\u00F3n y distribuci\u00F3n que se encargan de llevar electricidad a usuarios residenciales.','',0,0,1);
...
<div class="Titles">
	<h2 class="ExerciseTitle">Quiz-conc. redes</h2>
...
<li class="QuizQuestion" id="Q_0" style="display: none;"><div class="QuestionText">&#x00BF;Qu&#x00E9; es una red inform&#x00E1;tica?</div><ol class="MCAnswers"><li id="Q_0_0"><button class="FuncButton" id="Q_0_0_Btn" onclick="CheckMCAnswer(0,0,this)">?</button>&#160;&#160;Tejido de mallas, cuerdas, alambres, etc, realizado para diversos usos. ej: (red de pesca).</li><li id="Q_0_1"><button class="FuncButton" id="Q_0_1_Btn" onclick="CheckMCAnswer(0,1,this)">?</button>&#160;&#160;Conjunto de ordenadores que se conectan entre s&#x00ED; e intercambian informaci&#x00F3;n constantemente.</li><li id="Q_0_2"><button class="FuncButton" id="Q_0_2_Btn" onclick="CheckMCAnswer(0,2,this)">?</button>&#160;&#160;Es aquella conformada por generadores el&#x00E9;ctricos, transformadores l&#x00ED;neas de transmisi&#x00F3;n y distribuci&#x00F3;n que se encargan de llevar electricidad a usuarios residenciales.</li></ol></li></ol>
