...
I[0][2]='0';
I[0][3]=new Array();
I[0][3][0]=new Array('0 y 1','',1,100,1);
I[0][3][1]=new Array('1 y 2','',0,0,1);
I[0][3][2]=new Array('8','',0,0,1);
...
<li class="QuizQuestion" id="Q_0" style="display: none;"><div class="QuestionText">&#x00BF;Cu&#x00E1;les son los valores que representan un bit?</div><ol class="MCAnswers"><li id="Q_0_0"><button class="FuncButton" id="Q_0_0_Btn" onclick="CheckMCAnswer(0,0,this)">?</button>&#160;&#160;0 y 1</li><li id="Q_0_1"><button class="FuncButton" id="Q_0_1_Btn" onclick="CheckMCAnswer(0,1,this)">?</button>&#160;&#160;1 y 2</li><li id="Q_0_2"><button class="FuncButton" id="Q_0_2_Btn" onclick="CheckMCAnswer(0,2,this)">?</button>&#160;&#160;8</li></ol></li></ol>
