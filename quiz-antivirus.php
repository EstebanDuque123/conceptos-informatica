...
<meta name="dc:title" content="Quiz antivirus" />
<script src="http://ajax.googleapis.com/ajax/libs/jquery/2.1.1/jquery.min.js" type="text/javascript"></script>

<script>
	function enviar()
	{
		    var v1= "Quiz antivirus";
...
I[0][2]='0';
I[0][3]=new Array();
I[0][3][0]=new Array('Es una amenaza para la inform\u00E1tica, ya que estos tienen la cualidad de robar informaci\u00F3n importante.','',0,0,1);
I[0][3][1]=new Array('Es un tipo de software que se utiliza para evitar, buscar, detectar y eliminar virus de una computadora.','',1,100,1);
I[0][3][2]=new Array('Es un microorganismo que causa enfermedades.','',0,0,1);
...
<div class="Titles">
	<h2 class="ExerciseTitle">Quiz antivirus</h2>
...
<li class="QuizQuestion" id="Q_0" style="display: none;"><div class="QuestionText">&#x00BF;Qu&#x00E9; es un antivirus?</div><ol class="MCAnswers"><li id="Q_0_0"><button class="FuncButton" id="Q_0_0_Btn" onclick="CheckMCAnswer(0,0,this)">?</button>&#160;&#160;Es una amenaza para la inform&#x00E1;tica, ya que estos tienen la cualidad de robar informaci&#x00F3;n importante.</li><li id="Q_0_1"><button class="FuncButton" id="Q_0_1_Btn" onclick="CheckMCAnswer(0,1,this)">?</button>&#160;&#160;Es un tipo de software que se utiliza para evitar, buscar, detectar y eliminar virus de una computadora.</li><li id="Q_0_2"><button class="FuncButton" id="Q_0_2_Btn" onclick="CheckMCAnswer(0,2,this)">?</button>&#160;&#160;Es un microorganismo que causa enfermedades.</li></ol></li></ol>
