...
<meta name="dc:title" content="&#x00BF;Qu&#x00E9; es un programa?" />
<script src="http://ajax.googleapis.com/ajax/libs/jquery/2.1.1/jquery.min.js" type="text/javascript"></script>

<script>
	function enviar()
	{
		    var v1= "Quiz conceptos de programacion";
...
I[0][2]='0';
I[0][3]=new Array();
I[0][3][0]=new Array('Conjunto de instrucciones que se usa para controlar las tareas de una m\u00E1quina o computadora.','',1,100,1);
I[0][3][1]=new Array('Planificaci\u00F3n ordenada de distintas actividades que se van a realizar.','',0,0,1);
I[0][3][2]=new Array('Conjunto de emisiones peri\u00F3dicas que se identifican bajo un mismo t\u00EDtulo y ofrecen contenidos segmentados por bloques.','',0,0,1);
...
<div class="Titles">
	<h2 class="ExerciseTitle">&#x00BF;Qu&#x00E9; es un programa?</h2>
...
<li class="QuizQuestion" id="Q_0" style="display: none;"><div class="QuestionText"></div><ol class="MCAnswers"><li id="Q_0_0"><button class="FuncButton" id="Q_0_0_Btn" onclick="CheckMCAnswer(0,0,this)">?</button>&#160;&#160;Conjunto de instrucciones que se usa para controlar las tareas de una m&#x00E1;quina o computadora.</li><li id="Q_0_1"><button class="FuncButton" id="Q_0_1_Btn" onclick="CheckMCAnswer(0,1,this)">?</button>&#160;&#160;Planificaci&#x00F3;n ordenada de distintas actividades que se van a realizar.</li><li id="Q_0_2"><button class="FuncButton" id="Q_0_2_Btn" onclick="CheckMCAnswer(0,2,this)">?</button>&#160;&#160;Conjunto de emisiones peri&#x00F3;dicas que se identifican bajo un mismo t&#x00ED;tulo y ofrecen contenidos segmentados por bloques.</li></ol></li></ol>
